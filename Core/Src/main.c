...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
  // Configure ST7735 Display Control Pins (PA2, PA3, PA4) as Output
  ...
  // Set CS and RES high by default
  HAL_GPIO_WritePin(GPIOA, ST7735_CS_Pin | ST7735_RES_Pin, GPIO_PIN_SET);

  // Configure Buttons (PB7, PB8, PB9) as Input with Pull-Up
